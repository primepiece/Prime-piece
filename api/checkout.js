...
const CATALOG = {
  ...
  'table-desert-crown':     { name: 'Desert Crown',          price: 3332 },
  'table-desert-drift':     { name: 'Desert Drift',          price: 249  },
  'table-desert-drift-2':   { name: 'Desert Drift 2.0',      price: 299  },
  ...
  'table-midnight-moon':    { name: 'Midnight Moon',         price: 3599 },
  'table-midnight-river':   { name: 'Midnight River',        price: 279  },
  'table-midnight-wave':    { name: 'Midnight Wave',         price: 319  },
  'table-mountain-breeze':  { name: 'Mountain Breeze',       price: 329  },
  'table-obsidian-storm':   { name: 'Obsidian Storm',        price: 3399 },
  'table-patagonia-platinum':{ name: 'Patagonia Platinum',   price: 329  },
  'table-pietra-noir':      { name: 'Pietra Noir',           price: 270  },
  'table-sage-plateau':     { name: 'Sage Plateau',          price: 2499 },
  ...
  'table-white-haven-lounge':{ name: 'White Haven Carrara Lounge Table', price: 1999 },
  // Bundles
